...
const toast_notification_options = {
  position: "top-center",
  transition: Zoom,
  autoClose: 1000,
...
export const notification = {
  success: (msg) => toast.success(msg, toast_notification_options),
  warning: (msg) => toast.warning(msg, toast_notification_options),
...
export function filterObj(obj, filterText) {
  ...
  Object.entries(obj).forEach(([key, value]) => {
    ...
    if (flag === true) {
      ...
      var filtered_value = filterObj(value, filterText);
      if (Object.keys(filtered_value).length > 0) {
        filtered_obj[key] = value;
      }
...
export function manageDarkModeClasses(darkMode) {
  if (darkMode) {
